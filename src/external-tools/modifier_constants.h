...
// Rotation (degrés)
constexpr float MIN_ROTATE = -2.0f;
constexpr float MAX_ROTATE =  2.0f;
...
constexpr float MIN_SALT   =  0.01f;
constexpr float MAX_SALT   =  0.13f;
constexpr float MIN_PEPPER =  0.01f;
constexpr float MAX_PEPPER =  0.13f;
...
constexpr int   MIN_CONTRAST = -20;
constexpr int   MAX_CONTRAST =  20;
constexpr int   MIN_BRIGHT   = -20;
constexpr int   MAX_BRIGHT   =  20;
