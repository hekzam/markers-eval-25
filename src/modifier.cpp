...
// void add_salt_pepper_noise(float noise_ratio) 
// {
...
void Add_gaussian_Noise(cv::Mat &srcArr,double mean,double sigma)       //TO DO
{
...
int main(int argc, char const* argv[]) 
{
    ...
    add_salt_pepper_noise(noisy_img, 0.01f, 0.01f);  // Ajoute le bruit
