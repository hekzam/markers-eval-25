typst compile --root . test/copie/original_copy.typ ./copies/original.png --input nb-copies=1 --input exam-id="test1"
...
typst compile --root . test/copie/circle_copy.typ ./copies/circle.png --input nb-copies=1 --input exam-id="test1"
