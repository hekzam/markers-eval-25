...
show_usage() {
  ...
  echo "  --marker-margin N            : Margin around markers (default: 3)"
  echo "  --content-margin-x N  : Horizontal margin for content in mm (default: 10)"
  echo "  --content-margin-y N  : Vertical margin for content in mm (default: 10)"
